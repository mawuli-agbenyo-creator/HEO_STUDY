...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@100;200;300;400;500;600;700&family=Poppins:ital,wght@0,300;0,400;0,500;0,800;1,600;1,700&display=swap"
        rel="stylesheet">
...
<body>
    <div class="register-box">
        <!-- multistep form -->
        <form id="msform" action="{{ route('reg_submit') }}" enctype="multipart/form-data" method="POST"
            class="form">
            @csrf
            <!-- progressbar -->
            <ul id="progressbar">
          ...
          <input type="button" name="next" class="next action-button" value="Next" />
            ...
            <fieldset>
                ...
                <input type="tel" name="parent_guardian_phone" id="parentGuardianPhone"
                    placeholder="Parent/Guardian phone number" required>
                @error('parent_guardian_phone')
                    <p>{{ $message }}</p>
                @enderror

                <textarea name="parent_guardian_address" id="parentGuardianAddress" rows="4" placeholder="Parent/Guardian address"
                    required></textarea>
            ...
            <fieldset>
                ...
                <input type="text" id="educationLevel" name="education_level"
                    placeholder="Your current/highest level of education" required>
                ...
                <input type="text" id="businessNature" name="business_nature"
                ...
                <div class="section">
                    ...
                    <p>Highlight key achievements, experiences, and motivations related to technology and HEO,
                        specifically your chosen career path.</p>
                    <p>Proofread your statement carefully before submitting it.</p>
                </div>

                <div class="section">
                    <h2>Additional Requirements</h2>
                    <p>You may be required to submit additional documents, such as transcripts or letters of
                        recommendation, upon request.</p>
